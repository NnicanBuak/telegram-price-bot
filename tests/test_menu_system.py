...
from src.menu_system import Menu, MenuItem, MenuManager, MenuMiddleware
...
class TestMenuItem:
    ...
    def test_menu_item_defaults(self):
        ...
        item = MenuItem(id="test", text="Test", callback_data="test")
...
class TestMenu:
    ...
    def test_method_chaining(self):
        ...
        ).add_item(MenuItem(id="item2", text="Item 2", callback_data="cb2"))
...
class TestMenuManager:
    ...
    def test_build_keyboard_with_icons(self, manager):
        ...
        menu = Menu(id="test", title="Test")
        menu.add_item(
            MenuItem(id="1", text="Settings", icon="⚙️", callback_data="settings")
        )
    ...
    def test_build_keyboard_with_back_button(self, manager):
        ...
        menu = Menu(id="test", title="Test", back_button=True, back_to="main")
    ...
    def test_visibility_control(self, manager):
        ...
        menu = Menu(id="test", title="Test")
        menu.add_item(
            MenuItem(id="1", text="Visible", callback_data="cb1", visible=True)
        )
        menu.add_item(
            MenuItem(id="2", text="Hidden", callback_data="cb2", visible=False)
        )
    ...
    def test_admin_only_items(self, manager):
        ...
        menu = Menu(id="test", title="Test")
        menu.add_item(
            MenuItem(id="1", text="Admin Only", callback_data="cb1", admin_only=True)
        )
        menu.add_item(
            MenuItem(id="2", text="Public", callback_data="cb2", admin_only=False)
        )
    ...
    async def test_navigate_to_access_denied(self, manager):
        ...
        callback.answer.assert_called_with("Нет доступа к этому меню", show_alert=True)
    ...
    def test_add_dynamic_menu(self, manager):
        ...
        menu = manager.add_dynamic_menu(
            menu_id="dynamic_test", title="Dynamic Menu", items=items, back_to="main"
        )
